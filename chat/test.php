...
if(isset($_POST['messageSubmit'])){
    $messagesContent = $_POST['messagesContent'];
    if($messagesContent !== ""){
        $sqlMessage = "INSERT INTO messagebox (messages,dates,message_id) VALUES ('".$messagesContent."', '".$clock."', '".$_SESSION["types"]."')";
        $conn->query($sqlMessage) === TRUE;
    }else{
        echo 'gitmedi';
    }
...
<head>
    ...
    <link rel="stylesheet" href="assets/libs/%40simonwep/pickr/themes/nano.min.css"> <!-- 'classic' theme -->
                    ...
                    <li class="nav-item dropdown profile-user-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-between"
                                href="logout.php">Log out <i class="bx bx-log-out-circle text-muted ms-1"></i></a>
                        </div>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="chat-room-list" data-simplebar="">
                            ...
                            <div class="chat-message-list">
                                <ul class="list-unstyled chat-list chat-user-list" id="favourite-users">
                                    <?php 
                                        $dashSelect = "SELECT * FROM user WHERE types!='".$_SESSION['types']."'";
                                        $dashResult = $conn->query($dashSelect);
                                        if ($dashResult->num_rows > 0) {
                                            // output data of each row
                                            while($dashRow = $dashResult->fetch_assoc()) {
                                               $zehra = $dashRow['names'];
                                    ?>
                                    <li id="contact-id-<?=$dashRow['id'];?>" data-name="favorite" class="active"> <a
                                            href="javascript: void(0);" class="unread-msg-user">
                                            <div class="d-flex align-items-center">
                                                <div class="chat-user-img online align-self-center me-2 ms-0"> <img
                                                        src="assets/images/users/<?=$dashRow['avatar'];?>"
                                                        class="rounded-circle avatar-xs" alt=""><span
                                                        class="user-status"></span> </div>
                                                <div class="overflow-hidden me-2">
                                                    <p class="text-truncate chat-username mb-0"><?=$dashRow['names'];?></p>
                                                    <p class="text-truncate text-muted fs-13 mb-0">Hey, I'm going to
                                                        meet a friend of</p>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <?php } }?>   
                                    <li id="contact-id-2" data-name="favorite" class="active"> 
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="w-100 overflow-hidden position-relative">
                    ...
                    <div id="users-chat" class="position-relative">
                        <div class="py-3 user-chat-topbar">
                            <div class="row align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    <h6 class="text-truncate mb-0 fs-18"><a href="#"
                                                            class="user-profile-show text-reset"><?=$zehra?></a></h6>
                                                    <p class="text-truncate text-muted mb-0"><small>
                                                        
                                                        <?php 
                                                            if($_SESSION !== $_SESSION["types"]){
                                                              echo  "Online";
                                                            }else{
                                                                echo  "Offline";
                                                            }
                                ...
                                <h5>Hosgeldin <strong><?=  $_SESSION["user"];?></strong></h5>
                        ...
                        <ul class="list-unstyled chat-conversation-list" id="veriAlani">
                             <ul  class="list-unstyled chat-conversation-list" id="veriAlani"></ul>
                        </ul>
                    ...
                    <div class="position-relative">
                        <div class="chat-input-section p-4 border-top">
                            ...
                            <form id="chatinput-form" enctype="multipart/form-data" action="" method="POST">
                                   ...
                                   <div class="col">
                                        <div class="position-relative">
                                            ...
                                            <input autocomplete="off" type="text"
                                                ...
                                                id="chat-input" placeholder="Type your message..." name="messagesContent">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="chat-input-links ms-2 gap-md-1">
                                            ...
                                            <div class="links-list-item">
                                                <button name="messageSubmit" type="submit"
                        ...
                        <div class="pb-4 border-bottom border-bottom-dashed mb-4">
                            ...
                            <ul class="list-unstyled chat-list mx-n4">
                                <li>
                                    <a href="javascript: void(0);">
                                        <div class="d-flex align-items-center">
                                            <img src="assets/images/users/group-img.jpg" alt=""
                        ...
                        <div class="pb-4 border-bottom border-bottom-dashed mb-4">
                            ...
                            <div class="profile-media-img">
                                <div class="row g-1">
                                    ...
                                    <div class="col-lg-4 col-6">
                                        <a href="#">
                                            <img src="assets/images/small/img-5.jpg" alt="media img"
                                                class="img-fluid rounded">
                                        </a>
                                    </div>
                                    <div class="col-lg-4 col-6">
                                        <div class="position-relative rounded overflow-hidden">
                                            <a href="javascript:void(0);" class="d-block">
                                                <img src="assets/images/small/img-6.jpg" alt="media img"
                                                    class="img-fluid rounded">
            ...
            <div class="row mt-4">
                <div class="col-lg-12">
                    <div class="d-flex mb-3">
                        <h6 class="flex-grow-1 text-muted text-uppercase fs-13 mb-0">Select Custome Colors to Picker
                        </h6>
                    </div>
                </div>
                <!--end col-->
